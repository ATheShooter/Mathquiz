package theprofessor.project.com.mathquiz;
...
public class AuthUiActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (ConfigurationUtils.isGitHubMisconfigured(this)) {
            ...
            mUseGitHubProvider.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
    ...
    private List<AuthUI.IdpConfig> getSelectedProviders() {
        ...
        if (mUseGitHubProvider.isChecked()) {
            selectedProviders.add(new AuthUI.IdpConfig.GitHubBuilder()
